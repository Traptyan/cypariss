...
describe('qweqwe', () => {
    ...
    it('3.2а enable check', () => {
      ...
      cy.get(':nth-child(2) > .w-mask-area > :nth-child(1) > .card-body > .form-gr-row > .input-group-append > .ml-1').click();
      cy.contains('Удалить все ответы').should('exist');
      cy.get('.swal2-cancel').click();

      cy.get(':nth-child(3) > .w-mask-area > :nth-child(1) > .card-body > .form-gr-row > .input-group-append > .ml-1').click();
      cy.contains('Удалить все ответы').should('exist');
      cy.get('.swal2-cancel').click();

      cy.get(':nth-child(4) > .w-mask-area > :nth-child(1) > .card-body > .form-gr-row > .input-group-append > .ml-1').click();
      cy.contains('Удалить все ответы').should('exist');
      cy.get('.swal2-cancel').click();

      cy.get(':nth-child(5) > .w-mask-area > :nth-child(1) > .card-body > .form-gr-row > .input-group-append > .ml-1').click();
      cy.contains('Удалить все ответы').should('exist');
      cy.get('.swal2-cancel').click();  
      ...
      cy.get(':nth-child(6) > .btn-light').click();
      cy.get('.form-control').then(($el) => {
